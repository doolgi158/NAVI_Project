...
import { setVerifyData, setDetailData, clearPaymentData } from "../slice/paymentSlice";
import { preparePayment, verifyPayment, confirmPayment } from "../api/paymentService";
import { initIamport } from "../util/iamport";

/* PortOne(아임포트) 결제 전체 흐름 */
// 결제 ID 생성 → 결제 요청 → 검증 → DB 반영
    ...
    const executePayment = async () => {
        ...
        try {
            ...
            const payData = {
                ...
                name: `${rsvType} 예약 결제`,
                amount: totalAmount,
                //buyer_name: formData?.name,     // [ TODO ] : 설정 안되어있음 다른곳에
                //buyer_tel: formData?.phone,     // [ TODO ]
                //buyer_email: formData?.email,   // [ TODO ]
            };
