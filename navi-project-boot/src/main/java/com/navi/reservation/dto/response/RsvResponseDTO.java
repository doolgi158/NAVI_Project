...
public class RsvResponseDTO {
    ...
    private Rsv.TargetType targetType;  // 예약 대상 구분 (예: ACC, AIR, DLV)
    private String targetId;            // 예약 대상 ID (예: ACC003)
    private String paymentId;           // 결제 승인번호 (예: IMP_67283051)
    private Rsv.PaymentMethod paymentMethod;    // 결제 수단 (예: KAKAO_PAY)
    private Integer totalAmount;                // 총 결제 금액 (예: 128000)
    private Rsv.PaymentStatus paymentStatus;    // 결제 상태 (예: 결제완료)
