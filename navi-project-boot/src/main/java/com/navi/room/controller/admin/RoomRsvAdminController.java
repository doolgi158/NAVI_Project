...
//import com.navi.room.dto.response.RoomRsvListResponseDTO;
...
//    @GetMapping("/list")
//    public ApiResponse<RoomRsvListResponseDTO> getReservationList(
...
//
//        RoomRsvListResponseDTO result = roomRsvService.getAdminReservationList(page, size, status, keyword);
...
//        return ApiResponse.success(roomRsvService.findByRoomRsvId(reserveId));
//    }
//
//    /* ✅ 관리자용 예약 상태 강제 변경 */
