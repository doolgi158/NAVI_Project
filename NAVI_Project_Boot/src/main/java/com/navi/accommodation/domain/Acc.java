...
//
//    @Column(name = "latitude", precision = 9, scale = 6, nullable = false,columnDefinition = "NUMBER(10, 6)")
//    private BigDecimal mapy;
//
//    @Column(name = "longitude", precision = 10, scale = 6, nullable = false,columnDefinition = "NUMBER(10, 6)")
