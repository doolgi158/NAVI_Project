...
//
//    @Column(name = "latitude", precision = 9, scale = 6, nullable = false, columnDefinition = "NUMBER(10, 7)")
//    private Double mapy = 0.0;
//
//    @Column(name = "longitude", precision = 10, scale = 6, nullable = false, columnDefinition = "NUMBER(10, 7)")
